                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden"
                                style="background-image: url('https://i.pinimg.com/564x/c3/2a/cb/c32acb8b243d78c196a5ed7c89d52ea5.jpg');background-size: cover;">
                                <span class="mask bg-gradient-dark opacity-6"></span>
                                <h4 class="mt-5 text-white font-weight-bolder position-relative">My Canteen</h4>
                                <p class="text-white position-relative">Kantin atau warung sekolah adalah salah satu tempat yang menyediakan berbagai makanan / jajanan. Dengan sasaran anak sekolah dengan adanya kantin, sekolah dapat mengawasi anak didik untuk tidak jajan sembarang tempat.</p>
                            </div>
                        </div>
                    </div>
                </div>
