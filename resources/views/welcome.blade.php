...
<body class="">
    ...
    <main class="main-content  mt-0 ">
        <div class="page-header align-items-start min-vh-93 pt-10 pb-11 m-3 border-radius-lg"
            style="background-image: url('https://smkwikrama.sch.id/storage/1684465382-post.png'); background-position: top;">
            <span class="mask bg-gradient-dark opacity-6"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-5 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Halo Pengguna!</h1>
                        <p class="text-lead text-white"> Aplikasi Kantin</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-8 mx-auto text-center mt-1">
                    <p class="mb-0 text-secondary mt-3">
                        ...
                        </script>. Created Fahd abdullah fauzy
                    </p>
                </div>
            </div>
        </div>
